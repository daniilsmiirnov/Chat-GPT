...
## Пример на Redux
Теперь покажу примеры плохих и хороших запросов. Попробуем создать сайт на React и подключим к нему Redux.

1.Создадим приложениe на React. Зададим первый запрос в нашем чате.
![chat1](assets/images/chat1.png)
Как мы видим, чат выдал плохой ответ, он не указал как установить нужные библиотеки и node.js. Зададим правильный запрос
![chat2](assets/images/chat2.png)
Чат выдал подробную пошаговую инструкцию по инициализации нашего проекта.

Вот такой сайт мы получили:
![chat3](assets/images/chat3.png)

Теперь создадим страницу с инпутом и кнопкой. 
Хороший запрос:
![chat4](assets/images/chat4.png)
Указали технологии которые используем и расписали подробно задачу, в ответе получили структурированный подробный план действий.
Результат:
![chat6](assets/images/chat7.png)
Плохой запрос:
![chat5](assets/images/chat5.png)
Получили сухой ответ, без пояснений и плохим кодом с пробелами.
Результат:
